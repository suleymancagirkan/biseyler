...
const betaconf = require('../config.js');

exports.run = async (client, message, args) => {

    const embed = new Discord.MessageEmbed().setColor("#f1f1f1").setFooter(`${client.users.cache.get("852596827713962066").tag || "Süleyman"} yetkili başvuru sistemi.`)
