...
exports.run = async (client, message, args) => {
        ...
        if(!message.member.hasPermission("MANAGE_GUILD")) return message.reply(`${no} Bu Komudu Kullanmak İçin İzniniz Yok!`);
        ...
        if(!user) {
            ...
            if(isNaN(levelArgs) || levelArgs < 1) {
                ...
                .setTitle(`Başarılı!`)
                .setDescription(`${yes} ${levelArgs} level, ${user.toString()} kişisine başarıyla eklendi!`)
                .setColor("0x36393E");
